...
RESOLVED_DEFAULT_SET = {
    "agate", "annotated-doc", "annotated-types", "anyio", "attrs", "babel",
    "certifi", "charset-normalizer", "click", "cloudpickle", "colorama",
    "contourpy", "cycler", "daff", "dbt-adapters", "dbt-common", "dbt-core",
    "dbt-core-experimental-parser", "dbt-duckdb", "dbt-extractor", "dbt-protos",
    "deepdiff", "duckdb", "fonttools", "formulaic", "h11", "httpcore", "httpx",
    "idna", "importlib-metadata", "interface-meta", "isodate", "jinja2",
    "joblib", "jsonschema", "jsonschema-specifications", "kiwisolver",
    "leather", "lightgbm", "llvmlite", "markdown-it-py", "markupsafe",
    "mashumaro", "matplotlib", "mdurl", "metricflow", "more-itertools",
    "msgpack", "mypy-extensions", "narwhals", "networkx", "numba", "numpy",
    "opentelemetry-api", "orderly-set", "orjson", "packaging", "pandas",
    "pandera", "parsedatetime", "pathspec", "patsy", "pillow", "polars",
    "polars-runtime-32", "protobuf", "pyarrow", "pydantic", "pydantic-core",
    "pygments", "pyparsing", "pypdf", "python-dateutil", "python-dotenv",
    "python-slugify", "pytimeparse", "pytz", "pyyaml", "rapidfuzz",
    "referencing", "requests", "rich", "rpds-py", "scikit-learn", "scipy",
    "shellingham", "six", "snowplow-tracker", "sqlglot", "sqlparse",
    "statsmodels", "tabulate", "tenacity", "text-unidecode", "threadpoolctl",
    "tqdm", "typeguard", "typer", "typing-extensions", "typing-inspect",
    "typing-inspection", "tzdata", "urllib3", "wrapt", "zipp", "zstandard",
}
